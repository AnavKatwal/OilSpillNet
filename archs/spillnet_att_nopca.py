...
def iterLBlock(x, filters, name=None):
    ...
    #conv_1x1 = initial_conv2d_bn(conv_1x1, filters_1x1, 1, 1, padding='same', activation='selu')
...
def OilSpillNet_Dropout_Without_PCA(input_filters, height, width, n_channels):
...
# Iteration 2
    ...
    model = Model(model_input, outputs, name="OilSpillNet_Dropout_Without_PCA")
...
# Define the model
    ...
    model = OilSpillNet_Dropout_Without_PCA(32, 256, 256, 3)
