...
def IterLUNet_V1(input_filters, height, width, n_channels):
	...
	bottleneck1 = attention_block(pool1, filters*2, name = 'iterLBlock1')
	...
	bottleneck2 = attention_block(pool21, filters*8, name = 'iterLBlock5')
	...
	# Iteration 3
	encoder3 = initial_conv2d_bn(inputs, filters*2, 3, 3, padding='same', activation='gelu')
	...
	bottleneck3 = attention_block(pool32, filters*16, name = 'iterLBlock11')
...
# Define the model
	...
	model = IterLUNet_V1(32, 256, 256, 3)
	print(model.summary())
